...
public class CarMovementSystem : CarSystem
{


    // Input names to read using GetAxis
    [SerializeField] internal VehicleInputs m_Inputs;
    string moveInput => m_Inputs.ThrottleInput + main.PlayerNumber;
    string brakeInput => m_Inputs.BrakeInput + main.PlayerNumber;
    string turnInput => m_Inputs.TurnInput + main.PlayerNumber;
    string jumpInput => m_Inputs.JumpInput + main.PlayerNumber;
    string driftInput => m_Inputs.DriftInput + main.PlayerNumber;
    string boostInput => m_Inputs.BoostInput + main.PlayerNumber;
